    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">{{ __('Upload Scan Result(s)') }}</div>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('upload.scan.nurse.store') }}"
      ...
      @endif
                                ...
                                <div class="row mb-4">
                                    <label for="scan"
                                        class="col-md-2 col-form-label text-md-end">{{ __('Scan(s)') }}</label>

                                    <div class="col-md-8 original">
                                        <div class="input-group mb-2">
                                            <input class="form-control @error('scan') is-invalid @enderror" type="file" name="scan[]" >
